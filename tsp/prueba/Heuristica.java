...
public class Heuristica {
    ...
    public void mostarCoste() {
     ...
     /**
     * Metodo privado que a partir de un array de instancias te devuelve que ciudades están ocupadas
     */
    private ArrayList<Ciudad> ciudadesOcupadas(ArrayList<Ciudad> instancias) {
     ...
     /**
     * Metodo privado que a partir de un array de instancias te devuelve que ciudades están libres
     */
    private ArrayList<Ciudad> ciudadesLibres(ArrayList<Ciudad> instancias) {
     ...
     /**
     * Metodo privado que devvuelve el coste calculado a partir de pasarle una lista de las ciudades ya visitadas
     */
    ...
    /**
     * Metodo público que no retorna nada y que aplica el lgoritmo del vecino más cercano. Este es el método que resuelve el problema
     */
    ...
    /**
     * Metodo público que no retorna nada y que aplica el algoritmo 2
     */
    ...
    /**
     * Metodo público que no retorna nada y que aplica el algoritmo 3
     */
